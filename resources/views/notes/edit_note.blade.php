...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/postnoteupdate') }}">
...
<div class="col-md-6">
<input id="link" type="text" class="form-control" name="link" value="{{$note->link}}">
@if ($errors->has('link'))
<span class="help-block">
...
<textarea id="body" class="form-control" cols="50" rows="10" name="body">{{$note->body}}</textarea>
